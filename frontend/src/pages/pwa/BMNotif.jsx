...
const notifications = [
  { id: 1, type: "alert", message: "Kiran Kumar achieved monthly target", time: "2 hours ago", read: false },
  { id: 2, type: "success", message: "New booking confirmed - ₹8.5L Mumbai HQ", time: "5 hours ago", read: false },
  { id: 3, type: "info", message: "Weekly report is ready for review", time: "1 day ago", read: true },
  { id: 4, type: "warning", message: "Ritu Sharma has pending visit", time: "2 days ago", read: true },
];

export default function BMNotif() {
