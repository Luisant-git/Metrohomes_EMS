...
export default function AddBDM() {
  ...
  const allBDMs = users.filter(u => u.role === "BDM");
  const employeeCode = `BDM-${String(allBDMs.length + 1).padStart(3, '0')}`;
  ...
  return (
    <div className="pb-40 px-4 relative z-10">
      ...
      <div className="pt-4">
        ...
        <h2 className="text-2xl font-extrabold text-gray-900 mt-2 mb-3">Add Business Development Manager</h2>
