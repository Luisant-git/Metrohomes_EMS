...
const notifications = [
  { id: 1, type: "alert", message: "Manoj Tiwari achieved weekly target of 3 customers", time: "2 hours ago", read: false },
  { id: 2, type: "success", message: "New booking confirmed - ₹5L Commercial Space", time: "5 hours ago", read: false },
  { id: 3, type: "info", message: "Performance report is ready", time: "1 day ago", read: true },
  { id: 4, type: "warning", message: "Sonia Kapoor has pending visit", time: "2 days ago", read: true },
];

export default function BDMNotif() {
