...
export default function CommissionManagement() {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2"><Coins size={22} className="text-amber-500 flex-shrink-0" />Commission Management</h1>
        <p className="text-slate-500 text-sm mt-0.5">Auto-calculated role-wise commission breakdown</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Calculator */}
        <div className="card p-6 space-y-5">
          <h3 className="font-semibold text-gray-800 flex items-center gap-2"><Calculator size={18} />Commission Calculator</h3>
            ...
            {ROLE_ORDER.map(role => {
              ...
              return (
                <div key={role} className="flex items-center justify-between">
                  <span className={`text-xs font-medium px-2.5 py-1 rounded-full ${roleColors[role]}`}>{role}</span>
        ...
        <div className="card p-6">
          <h3 className="font-semibold text-gray-800 mb-5">Commission Per Booking</h3>
      ...
      <div className="card p-6">
        <h3 className="font-semibold text-gray-800 mb-4">Total Commission Earned (All Bookings)</h3>
