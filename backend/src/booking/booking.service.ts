...
export class BookingService {
  ...
  private formatBooking(b: any) {
    ...
    return {
      ...
      creatorEmployeeCode: b.creator?.employeeCode || '',
      createdUser: b.creator ? { id: b.creator.id, name: b.creator.name, role: b.creator.role, employeeCode: b.creator.employeeCode } : null,
